...
/**
 * This class adds structure of 'RBAC_ROLE_PERMISSION' table to 'app' DatabaseMap object.
 *
 *
 *
 ...
 */
class RbacRolePermissionMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'classes.model.map.RbacRolePermissionMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('RBAC_ROLE_PERMISSION');
		$tMap->setPhpName('RbacRolePermission');
